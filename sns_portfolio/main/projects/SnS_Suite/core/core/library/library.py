...
class Library:
    ...
    def __init__(self, base_directory):
        ...
        self.attributes = ['base', 'models']
        # The 'base' attribute works best with a relative path
        # from the location this object is instantiated
        self.base = base_directory
        if not os.path.isdir(self.base):
            os.makedirs(self.base)
        self.prefabs = os.path.join(self.base, 'prefabs')
        if not os.path.isdir(self.prefabs):
            os.makedirs(self.prefabs)
        self.models = {}
